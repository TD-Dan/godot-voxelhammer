...
export(Resource) var configuration setget _set_configuration
export(Resource) var voxel_data = VoxelData.new() setget _set_voxel_data
var paint_stack : VoxelPaintStack = null setget _set_paint_stack

export var voxel_paint_local = true # apply voxel paint stack in local coordinates instead of world coordinates
...
export(DISTANCE_MODE) var distance_tracking = DISTANCE_MODE.OFF setget _set_distance_tracking
export var use_qubic_distance = false
var _distance_update_skip_frames : int = 30
var _skip_counter : int = 0
export var distance_update_interval_seconds = 1.0 setget _set_distance_update_interval_seconds
var distance_tracked_node : Spatial = null
var distance_to_tracked : float = 0

export var lod_tracking = false setget _set_lod_tracking
export var lod_distance_min = 0.0
export var lod_distance_max = 1000.0


export var do_clear = false setget _set_do_clear
export var do_fill = false setget _set_do_fill
export var do_sphere = false setget _set_do_sphere
export var do_plane = false setget _set_do_plane
...
var mesh_debug
var debug_mesh_color = Color(0,0,0) setget _set_debug_mesh_color
var show_debug_mesh = false setget _set_show_debug_mesh
...
func _set_configuration(new_value):
	#print("set configuration to %s" % new_value)
	if configuration:
		if configuration.is_connected("voxel_configuration_changed", self, "_on_voxel_configuration_changed"):
			configuration.disconnect("voxel_configuration_changed", self, "_on_voxel_configuration_changed")
...
func _set_voxel_data(new_value):
	#print("_set_voxel_data")
	if voxel_data:
		if voxel_data.is_connected("voxel_data_changed", self, "_on_voxel_data_changed"):
			voxel_data.disconnect("voxel_data_changed", self, "_on_voxel_data_changed")
	
	voxel_data = new_value
...
func _set_debug_mesh_color(new_value):
	debug_mesh_color = new_value
